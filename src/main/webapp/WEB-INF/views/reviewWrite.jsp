...
<head>
    ...
    <link rel="stylesheet" href="/css/review_common.css">
    <link rel="stylesheet" href="/css/review_page_1.css">

</head>
<body>
<form action="./review_page_2.html" name="review_score" method="get" id="wrap">
        ...
        <div class="container contents_area">
            ...
            <div class="common_box main_score_box">
                ...
                <div class="ms_star_box">
                    ...
                    <input type="text" value="0.0"  class="score_user_main">
                    <span>/</span>
            ...
            <div class="common_box detail_box">
                <div class="detail_score_box">
                    ...
                    <div class="ms_star_box">
                        ...
                        <span class="score_user_kind">0.0</span>
                        <span>/</span>
                        <span class="score_base">5.0</span>
                    </div>
                </div>
                <div class="detail_score_box">
                    ...
                    <div class="ms_star_box">
                        ...
                        <span class="score_user_clean">0.0</span>
                        <span>/</span>
                        <span class="score_base">5.0</span>
                    </div>
                </div>
                <div class="detail_score_box">
                    ...
                    <div class="ms_star_box">
                        ...
                        <span class="score_user_taste">0.0</span>
                        <span>/</span>
                        <span class="score_base">5.0</span>
                    </div>
                </div>

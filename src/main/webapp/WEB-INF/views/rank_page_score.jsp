...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/css/rank_page_score.css"/>">
</head>
<body>
<div id="wrap">
                ...
                <div class="title_box">
                    ...
                    <div class="review_box">
                        ...
                        <div class="star_box">
                            ...
                            <span class="review_score">4.8</span>
                        </div>
    
                        <!-- 별점 스코어 밑 후기 갯수 관련 -->
                        <div class="review_leng">후기 23개</div>

                        <!-- 별점 스코어 밑 후기 갯수 관련 -->
                    </div>
    
                    <div class="rest_title_box">
                        <a href="./detail.html" class="rest_title">종찬식당</a>
                        <p class="rest_cate">한식</p>
                    </div>
                    <div class="rest_info_box">
                        <p class="rest_d_addr"><i class="rest_addr_icon"></i>서울시 강남구 역삼동 테헤란로</p>
                        <p class="rest_p_num"><i class="rest_num_icon"></i>0507-1316-0924</p>
                        <p class="rest_info"><i class="rest_info_icon"></i>예약가능, 주차가능, 배달가능, 포장불가</p>
                        <p class="rest_time"><i class="rest_time_icon"></i>화요일 09:00 ~ 22:00</p>
                    </div>
...
<script src="<c:url var='/resources/js/rank_page_score.js'/>"></script>
